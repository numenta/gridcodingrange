...
"""
Run experiments on parameters generated by generate_bases.py
"""
...
def measureSidelengths(folderPath, scaleMinimalBox):
    ...
    for filename in files:
        ...
        ms = result_dict["ms"]
        ks = result_dict["ks"]
        phrs = result_dict["phase_resolutions"]
        ...
        max_scale_factors = np.full((len(phrs),
                                     len(ms), len(ks)),
                                    np.nan, dtype="float")
        ...
        for phr, m, k in param_combinations:
            ...
            max_scale_factors[phrs.index(phr),
